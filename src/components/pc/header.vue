  ...
  >
    <div class="row items-center no-wrap">
      <q-img
        ...
        src="/images/default/pc/logo.png"
        width="172px"
        height="42px"
      />
      <span
        ...
        >
          <q-list style="min-width: 268px" class="q-py-sm">
            ...
            >
              <q-img
                class="q-mr-sm"
                :src="`/images/default/${item.url}.png`"
                width="38px"
                height="38px"
              />
              <div>
    ...
    <div class="row items-center no-wrap">
      ...
      <q-input placeholder="searching..." rounded outlined v-model="search">
        <template v-slot:prepend>
          <q-img
            class="q-mr-sm"
            src="/images/default/pc/search.png"
            width="20px"
            height="20px"
          />
        </template>
      ...
      <div v-if="isLogin" class="row items-center">
          ...
          >
            <q-list style="min-width: 214px" class="q-px-sm">
              ...
              >
                <q-img
                  class="q-mr-sm"
                  :src="`/images/default/pc/${item.url}.png`"
                  width="20px"
                  height="20px"
                />
                <div style="font-size: 16px">{{ item.name }}</div>
          ...
          >
            <q-list style="min-width: 218px; padding: 20px 23px 0 23px">
              ...
              >
                <q-img
                  class="q-mr-sm"
                  :src="`/images/default/pc/${item.img}.png`"
                  width="20px"
                  height="20px"
                />
                <div>{{ item.name }}</div>
              ...
              >
                <q-img
                  class="q-mr-sm"
                  src="/images/default/pc/LogOut.png"
                  width="20px"
                  height="20px"
                />
                <div>Log out</div>
        ...
        <!--  -->
        <q-img
          class="q-ml-md iconLogo cursor-pointer"
          src="/images/default/darkness/email.png"
        />
        <q-img
          class="q-ml-md iconLogo cursor-pointer"
      ...
      <q-img
        class="q-ml-md iconLogo cursor-pointer"
        src="/images/default/darkness/language.png"
      />
    </div>

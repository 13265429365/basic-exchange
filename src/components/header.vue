<template>
  <div>
    <q-header reveal class="bg-white text-color-3 row justify-between q-py-md q-pr-lg" style="padding-left: 107px;">
      <div class="row items-center">
        <q-img class="q-mr-lg" src="/images/default/pc/logo.png" width="172px" height="42px" />
        <span class="text-color-3 q-ml-sm q-mr-xl">Support Center</span>
        <div>
          <span>more</span>

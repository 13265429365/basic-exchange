<template>
  <q-header
    reveal
    class="bg-white text-color-3 row justify-between q-py-md q-pl-xl q-pr-lg no-wrap"
  >
    <div class="row items-center no-wrap">
      <q-img
        @click="to('/')"
        class="q-mr-lg cursor-pointer"
        src="/images/pc/header/logo.png"
        width="172px"
        height="42px"
      />
      <span
        @click="to('/help/center')"
        class="text-color-3 q-ml-sm q-mr-xl cursor-pointer"
        >Support Center</span
      >
        ...
        >
          <q-list style="min-width: 268px" class="q-py-sm">
            ...
            >
              <q-img
                class="q-mr-sm"
                :src="`/images/pc/header/${item.url}.png`"
                width="38px"
                height="38px"
              />
              <div>
    ...
    <div class="row items-center no-wrap">
      ...
      <q-input placeholder="searching..." rounded outlined v-model="search">
        <template v-slot:prepend>
          <q-img
            class="q-mr-sm"
            src="/images/pc/header/search.png"
            width="20px"
            height="20px"
          />
        </template>
      ...
      <div v-if="isLogin" class="row items-center">
        <!-- Deposit -->
        <q-btn
          class="q-ml-md text-weight-regular cursor-pointer"
          style="padding: 0 10px; min-height: 30px"
          unelevated
          rounded
          no-caps
          color="primary"
          ...
          >
            <q-list style="min-width: 214px" class="q-px-sm">
              ...
              >
                <q-img
                  class="q-mr-sm"
                  :src="`/images/pc/header/${item.name}.png`"
                  width="20px"
                  height="20px"
                />
                <div style="font-size: 16px">{{ item.name }}</div>
          ...
          >
            <q-list style="min-width: 218px; padding: 20px 23px 0 23px">
                  ...
                  <div class="col-8">
                    ...
                    <div class="row no-wrap">
                      <q-chip class="q-chip" style="border: 1px solid #f7deb6">
                        <q-img
                          class="vip"
                          src="images/pc/header/Vip_icon.png"
                        />
                        Lv.3
                      </q-chip>
                      <q-chip
                        class="q-chip bg-primary text-white"
              ...
              >
                <q-img
                  class="q-mr-sm"
                  :src="`/images/pc/header/${item.img}.png`"
                  width="20px"
                  height="20px"
                />
                <div>{{ item.name }}</div>
              ...
              <q-item
                @click="logOut()"
                clickable
                class="row no-wrap items-center q-py-xs q-px-xs"
              >
                <q-img
                  class="q-mr-sm"
                  src="/images/pc/header/LogOut.png"
                  width="20px"
                  height="20px"
                />
                <div>Log out</div>
        ...
        <q-img
          ...
          src="/images/pc/header/prompt.png"
        >
          <q-badge style="background: #f45e0c" class="badge" floating rounded
            >20</q-badge
          >
        </q-img>
      </div>
      ...
      <div v-else class="row items-center no-wrap">
        <q-btn
          ...
          class="q-ml-md text-color-3 text-weight-regular"
          style="padding: 0 10px; min-height: 30px"
          unelevated
          rounded
          no-caps
          ...
          <div class="q-mt-lg">
            <q-form>
              ...
              >
                <template v-slot:prepend>
                  <q-img
                    width="24px"
                    height="24px"
                    src="/images/pc/header/password.png"
                  />
                </template>
              ...
              >
                <template v-slot:prepend>
                  <q-img
                    width="24px"
                    height="24px"
                    src="/images/pc/header/code.png"
                  />
                </template>
                <template v-slot:append>
                  <q-img
                    no-spinner
                    v-if="userParams.captchaId !== ''"
                    :src="
                      imageSrc(
                        '/captcha/' + userParams.captchaId + '/200-50',
                        true
                      )
                    "
                    width="120px"
              ...
              <div class="text-center" style="font-size: 14px">
                First time here?
                <span @click="toRegister()" class="text-primary cursor-pointer"
                  >Signup</span
                >
              </div>
            </q-form>
          ...
          <div class="q-mt-lg">
            <q-form>
              ...
              >
                <template v-slot:prepend>
                  <q-img
                    width="24px"
                    height="24px"
                    src="/images/pc/header/email.png"
                  />
                </template>
              </q-input>
              <q-input
              ...
              <q-input
                class="q-mb-md"
                standout
                v-model="registerParams.captchaVal"
                placeholder="Code"
              >
                <template v-slot:prepend>
                  <q-img
              ...
              <q-input
                class="q-mb-md"
                standout
                v-model="registerParams.securityKey"
              ...
              <div class="row no-wrap">
                <q-select
                  @update:modelValue="newValue($event)"
                  v-model="areaCode"
                  :options="options"
                  class="q-mb-md q-mr-sm select"
                  standout
                >
                  <template v-slot:prepend>
                    <q-img
                      width="24px"
                      height="16px"
                      src="/images/pc/header/china.png"
                      @click.stop.prevent
                    />
                    <q-icon name="keyboard_arrow_down" />
                  </template>
              ...
              <div class="size14 text-center">
                ...
                <span @click="toLogin()" class="text-primary cursor-pointer"
                  >Login</span
                >
              </div>
            </q-form>

    ...
    <div class="calc">
      <div style="padding: 48px 100px;">
        ...
        <div class="background row items-center justify-between radius-8 q-pa-lg q-pr-xl">
          ...
          <!-- btn -->
          <div class="row">
            <q-btn @click="$router.push('/recharge')" class="text-primary bg-white no-shadow" rounded no-caps
              label="Recharge"></q-btn>
            <q-btn @click="$router.push('/withdrawal')" class="text-primary bg-white no-shadow q-ml-md" rounded no-caps
              label="Withdrawal"></q-btn>
          </div>
        </div>
        <!-- 表格 horizontal -->

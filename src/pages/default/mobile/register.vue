  ...
  <div class="register">
    <div>
      ...
      <q-form class="q-mt-lg q-px-lg">
        <!-- 邮箱 -->
        <q-input standout class="q-mb-md" v-model="params.email" placeholder="email">
        ...
        <!-- 密码 -->
        <q-input class="q-mb-md" v-model="params.password" standout :type="isPwd ? 'password' : 'text'"
        ...
        <!-- 验证码 -->
        <q-input class="q-mb-lg" standout v-model="params.captchaVal" placeholder="Code">
          <template v-slot:prepend>
        ...
        <!-- 秘钥 -->
        <q-input class="q-mb-md" standout v-model="params.securityKey" placeholder="Secret Key">
          <template v-slot:prepend>

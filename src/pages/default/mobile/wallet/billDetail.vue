      ...
      <q-card style="width: 320px">
        <q-card-section class="relative full-height">
          ...
          <div class="row no-wrap items-center">
            <q-input @click="startDatePouop = true" placeholder="开始时间" style="height: 34px;" standout v-model="startDate"
              mask="date">
            ...
            <q-input @click="endDatePouop = true" placeholder="结束时间" style="height: 34px;" standout v-model="endDate"
              mask="date">
              <template v-slot:append>
          ...
          <div class="row justify-between no-wrap absolute">
            <q-btn @click="dialog = false" class="bg-grey-2" unelevated rounded no-caps style="height: 44px;width: 140px;"
              label="Cancel" />
            <q-btn @click="dialog = false" unelevated rounded no-caps style="height: 44px;width: 140px;" color="primary"
              label="Confirm" />
          </div>
        </q-card-section>
      </q-card>

<template>
  <div class="column full-height full-width page_bg" style="padding: 48px 244px;">
    <div class="col q-pa-lg full-width column justify-between bg-white radius-8">
      <div class="col full-width">
        <div class="text-color-3 text-subtitle1 text-weight-medium page_bg q-py-sm q-px-md" style="border-radius: 2px;">
          Account Type
        </div>
        <!-- 卡类型选择 -->
        <q-scroll-area class="q-mt-lg" style="height: 60px; width: 100%;" :visible="false">
...
export default {
  name: 'rechargeIndex',
  components: { dialogAlert, uploader },
  setup() {

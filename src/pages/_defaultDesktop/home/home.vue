    ...
    <div style="padding: 120px 165px 70px 165px;">
      ...
      <div v-if="!isLogin">
        ...
        <div class="row no-wrap justify-between q-mb-xl q-py-xl">
          <q-card v-for="(item,i) in cardList" :key="i" class="q-my-lg q-mx-md" style="width: 299px;box-shadow: 0px 2px 4px 0px rgba(171,190,209,0.2)">
        ...
        <div class="row justify-between items-center no-wrap q-mb-xl q-py-xl">
          ...
          <div style="width: 660px;padding-right: 60px">
            ...
            <q-btn class="text-weight-regular" style="width: 152px;min-height: 52px"
              unelevated rounded no-caps color="primary" label="Learn More" />
          </div>
        </div>
